...
#define Alarm1_Address_Second 0x07 // 秒闹铃
#define Alarm1_Address_Minute 0x08 // 分闹铃
#define Alarm1_Address_Hour 0x09   // 时闹铃
#define Alarm1_Address_Week 0x0a   // 日闹铃、星期闹铃

#define Alarm2_Address_Minute 0x0b // 分闹铃
#define Alarm2_Address_Hour 0x0c   // 时闹铃
#define Alarm2_Address_Week 0x0d   // 日闹铃、星期闹铃
...
#define OUTPUT_INTSQW (1 << 2) // 使用中断输出模式（INTCN位）
...
#define Clear_A1IE_Flag (0 << 0) // 清除闹铃1中断标志

void DS3231_Init(void);
void DS3231_Get_Time(void);
// u8 RTC_Get_Week(u16 year,u8 month,u8 day);
void DS3231_Set_Time(void); // 设置时间
